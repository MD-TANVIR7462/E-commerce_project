...
exports.productValidat = exports.inventoryValidat = exports.variantsValidat = void 0;
...
exports.inventoryValidat = zod_1.z.object({
    quantity: zod_1.z.number().min(0, "inventory quantity must be a positive number"),
...
exports.productValidat = zod_1.z.object({
    ...
    tags: zod_1.z.array(zod_1.z.string().trim().nonempty("tags must be non-empty strings")),
    variants: zod_1.z.array(exports.variantsValidat).nonempty("variants are required"),
